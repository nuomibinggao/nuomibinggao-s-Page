...
<div class="container" id="mainContainer">
	...
	<div class="section-card" style="margin-top: 2rem;">
		...
		<a href="https://store.steampowered.com/app/977950/A_Dance_of_Fire_and_Ice" target="_blank" rel="noopener" class="link-button steam-button">
			<img src="/icons/steam_logo.png" alt="Steam" class="icon icon-inline">Get ADOFAI on Steam
		</a>
	</div>
