...
<div class="container" id="container">
    <header id="header">
      <div class="header-content">
        ...
        <nav class="nav">
          ...
          <a href="https://github.com/nuomibinggao/Melty-Pages" target="_blank" rel="noopener"><img src="icons/github_icon.svg" alt="Code" class="icon icon-inline">Source Code</a>
    ...
    <section class="intro">
      ...
      <p>This website is open source on <a href="https://github.com/nuomibinggao/Melty-Pages" target="_blank" rel="noopener"><img src="icons/github_icon.svg" alt="Code" class="icon icon-inline">GitHub</a>.</p>
